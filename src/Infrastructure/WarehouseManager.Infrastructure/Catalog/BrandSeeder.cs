...
namespace WarehouseManager.Infrastructure.Catalog;
...
public class BrandSeeder : ICustomSeeder
{
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        if (!_db.Brands.Any())
        {
            ...
            string brandData = await File.ReadAllTextAsync(path + "/Configurations/Catalog/brands.json", cancellationToken);
