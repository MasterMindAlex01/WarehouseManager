...
{
    private readonly IMultiTenantStore<WHMTenantInfo> _tenantStore;
    ...
    public TenantService(
        IMultiTenantStore<WHMTenantInfo> tenantStore,
    ...
    public async Task<string> CreateAsync(CreateTenantRequest request, CancellationToken cancellationToken)
    {
        ...
        var tenant = new WHMTenantInfo(request.Id, request.Name, request.ConnectionString, request.AdminEmail, request.Issuer);
    ...
    private async Task<WHMTenantInfo> GetTenantInfoAsync(string id) =>
