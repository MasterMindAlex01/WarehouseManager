...
internal static class Startup
{
    internal static IServiceCollection AddMultitenancy(this IServiceCollection services)
    {
        return services
            ...
            .AddMultiTenant<WHMTenantInfo>()
                .WithClaimStrategy(WHMClaims.Tenant)
                .WithHeaderStrategy(MultitenancyConstants.TenantIdName)
                .WithQueryStringStrategy(MultitenancyConstants.TenantIdName)
                .WithEFCoreStore<TenantDbContext, WHMTenantInfo>()
    ...
    private static FinbuckleMultiTenantBuilder<WHMTenantInfo> WithQueryStringStrategy(this FinbuckleMultiTenantBuilder<WHMTenantInfo> builder, string queryStringKey) =>
