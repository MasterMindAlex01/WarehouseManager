...
public class WHMTenantInfo : ITenantInfo
{
    public WHMTenantInfo()
    {
    }

    public WHMTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
