...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(WHMAction.View, WHMResource.Users)]
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(WHMAction.View, WHMResource.UserRoles)]
    ...
    [MustHavePermission(WHMAction.Update, WHMResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(WHMAction.Create, WHMResource.Users)]
    ...
    [MustHavePermission(WHMAction.Update, WHMResource.Users)]
    [ApiConventionMethod(typeof(WHMApiConventions), nameof(WHMApiConventions.Register))]
