...
{
    [HttpPost("search")]
    [MustHavePermission(WHMAction.Search, WHMResource.Products)]
    ...
    [HttpGet("{id:guid}")]
    [MustHavePermission(WHMAction.View, WHMResource.Products)]
    ...
    [HttpPost]
    [MustHavePermission(WHMAction.Create, WHMResource.Products)]
    ...
    [HttpPut("{id:guid}")]
    [MustHavePermission(WHMAction.Update, WHMResource.Products)]
    ...
    [HttpDelete("{id:guid}")]
    [MustHavePermission(WHMAction.Delete, WHMResource.Products)]
    ...
    [HttpPost("export")]
    [MustHavePermission(WHMAction.Export, WHMResource.Products)]
